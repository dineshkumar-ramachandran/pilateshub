/** Tiny line-icon set used for contact rows. Single component, no runtime
 *  deps — safe to render inside server components. */
type Name = "phone" | "clock" | "calendar" | "instagram" | "mail" | "pin";
